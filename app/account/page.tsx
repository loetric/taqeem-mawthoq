...
import { User, LoyaltyTransaction, Announcement, LoyaltyBadge } from '@/types';
import { Star, Gift, TrendingUp, Settings, LogOut, Edit, MapPin, Bell, Plus, X, Award, Crown, Gem, Zap, Shield, CheckCircle } from 'lucide-react';
                    ...
                    >
                      <div className="flex flex-col items-center text-center">
                        ...
                        <div className={`font-bold text-sm mb-1 ${
                          isCurrent ? tierInfo.textColor : hasBadge ? tierInfo.textColor : 'text-gray-700'
                        }`}>
                          {tierInfo.name}
                        </div>
                        {badge !== 'expert' && (
                          <div className={`text-xs ${
                            isCurrent ? 'text-gray-600' : hasBadge ? 'text-gray-600' : 'text-gray-500'
                          }`}>
                            {pointsNeeded}+ نقطة
                          </div>
                        )}
                        {isCurrent && (
                          <div className="mt-2 text-xs font-semibold text-green-600">الحالي</div>
                        )}
                      </div>
                    </div>
                  );
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          >
            <div className="flex items-center space-x-3 space-x-reverse">
              ...
              <span className="font-semibold text-gray-800">الملف الشخصي</span>
            </div>
            <span className="text-gray-400">›</span>
          </Link>
          <button
